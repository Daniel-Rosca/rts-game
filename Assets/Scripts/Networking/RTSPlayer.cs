...
public class RTSPlayer : NetworkBehaviour
{
    ...
    {
        //verificam daca exista un overlap
        ...
        //verificam daca suntem in range
   ...
   [Server]
    ...
    public void CmdTryPlaceBuilding(int buildingId, Vector3 point)
    {
        ...
        //verificam daca avem resursele necesare
    ...
    public override void OnStopClient()
    {
        ...
        if (!isClientOnly) { return; }//it stoops at this point if we are the server 

        ((CustomNetworkManager)NetworkManager.singleton).Players.Remove(this);

        if (!hasAuthority) { return; }//if we dont have authorit dont do below
