...
public class UnitSpawner : NetworkBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private float unitSpawnDuraton = 5f;

    [SyncVar(hook =nameof(ClientHandlQueuedUnitsUpdated))]
    ...
    private void ProduceUnits()
    {
        ...
        if(unitTimer < unitSpawnDuraton) { return; }
    ...
    {
        float newProgress = unitTimer / unitSpawnDuraton;
    ...
    private void ClientHandlQueuedUnitsUpdated(int oldUnits, int newUnits)
    {
